...
- A Todoist project for captures (default project ID `6fVCFGxCf6MVJwm8` = **NOTE TaskBot 📨🤖**)
- Todoist API token
...
`targetProjectId` is optional — it defaults to **NOTE TaskBot 📨🤖**. Override only if you use a different project.
