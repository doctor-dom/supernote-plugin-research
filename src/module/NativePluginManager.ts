...
export interface Spec extends TurboModule {
  ...
  // Callback invoked when the plugin is mounted successfully
  onMounted(): void;

  // Callback invoked when the plugin stops running
  onStop(): void;
...
export default TurboModuleRegistry.getEnforcing<Spec>('NativePluginManager');
